...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback{
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			...
			if(camParas.getFocusMode().equals(Camera.Parameters.FOCUS_MODE_AUTO)||camParas.getFocusMode().equals(Camera.Parameters.FOCUS_MODE_MACRO)){
				...
				Toast.makeText(getContext(), "�Ӭ۾����䴩�۰ʹ�J", Toast.LENGTH_SHORT).show();
			}
		} catch (Exception e) {
			// TODO: handle exception
			Toast.makeText(getContext(), "�Ӭ۾��Ұʿ��~", Toast.LENGTH_LONG).show();
		}
	}
	...
	Camera.AutoFocusCallback onCamAutoFocus = new Camera.AutoFocusCallback() {
		...
		public void onAutoFocus(boolean success, Camera camera) {
			// TODO Auto-generated method stub
			Toast.makeText(getContext(), "�۰ʹ�J!", Toast.LENGTH_SHORT).show();
		}
	};
